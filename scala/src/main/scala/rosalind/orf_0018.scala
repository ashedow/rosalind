...
// object ORF extends App with RosalindTools {	
...
// 	def proteinCandidate(proteinStr: String):String = {

//     }
// 	runWithInputOutput("input/rosalind_orf.txt")("output/ORF.txt")(proteinCandidate)
// }